...
def value_of_ace(card_one, card_two) -> Literal[1, 11]:
    ...
    return 11 if value_card_in_hand(card_one) + value_card_in_hand(card_two) < 11 else 1
...
def is_blackjack(card_one, card_two) -> bool:
    ...
    return value_card_in_hand(card_one) + value_card_in_hand(card_two) == 21
...
def value_card_in_hand(card) -> int:
